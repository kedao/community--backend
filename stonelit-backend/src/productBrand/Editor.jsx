...
const Editor = ({history, match}) => {
    ...
    function onSubmit(fields, {setStatus, setSubmitting}) {
        ...
        data.logo = fileUrls && fileUrls.length ? fileUrls[0] : '';
                                ...
                                <Form>
                                    <fieldset className="mb-3">
                                        ...
                                        <div className="form-group row">
                                            <label className="col-lg-2 col-form-label font-weight-semibold">品牌名称 <span className="text-danger">*</span></label>
                                        ...
                                        <div className="form-group row">
                                            <label className="col-lg-2 col-form-label font-weight-semibold">品牌官网</label>
                                        ...
                                        <div className="form-group row">
                                            <label className="col-lg-2 col-form-label font-weight-semibold">图片 <span className="text-danger">*</span></label>
                                            <div className="col-lg-10">
