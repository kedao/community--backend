...
const validationSchema = Yup.object().shape({
    ...
    supportPlatform: Yup.string().required('请选择支持的平台'),
...
const Editor = ({history, match}) => {
    ...
    useEffect(() => {
        ...
        const fetchSupportPlatforms = async () => {
            try {
                const response = await sysDict.selectById(3);
                const data = response.data;
                        ...
                        return (
                            <Form>
                                <fieldset>
                                    ...
                                    <Forms.Select field="supportPlatform" label="支持的平台" options={[{value: '', label: ''}, ...supportPlatforms]} />
                                </fieldset>
