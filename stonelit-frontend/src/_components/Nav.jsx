                            ...
                            <div className="dropdown-content-body dropdown-scrollable">
                                <ul className="media-list">
                                    <li className="media">
                                        ...
                                        <div className="media-body">
                                            <a href="#" className="media-title font-weight-semibold">Jordana
                                                Ansley</a>
                                            <span
                                                className="d-block text-muted font-size-sm">Lead web developer</span>
                                        </div>
                                    ...
                                    <li className="media">
                                        ...
                                        <div className="media-body">
                                            ...
                                            <span
                                                className="d-block text-muted font-size-sm">Marketing manager</span>
                                        </div>
                                        <div className="ml-3 align-self-center"><span
                                            className="badge badge-mark border-danger"></span></div>
                                    </li>
                                    ...
                                    <li className="media">
                                        ...
                                        <div className="media-body">
                                            <a href="#" className="media-title font-weight-semibold">Hanna
                                                Walden</a>
                                    ...
                                    <li className="media">
                                        ...
                                        <div className="media-body">
                                            <a href="#" className="media-title font-weight-semibold">Dori
                                                Laperriere</a>
                                            <span
                                                className="d-block text-muted font-size-sm">Business developer</span>
                                        </div>
                                        <div className="ml-3 align-self-center"><span
                                    ...
                                    <li className="media">
                                        ...
                                        <div className="media-body">
                                            <a href="#" className="media-title font-weight-semibold">Vanessa
                                                Aurelius</a>
                        ...
                        <div className="dropdown-menu dropdown-menu-right dropdown-content wmin-md-350">
                                        ...
                                        <div className="media-body">
                                            <div className="media-title">
                                                <a href="#">
                                                    ...
                                                    <span
                                                        className="text-muted float-right font-size-sm">04:58</span>
                                                </a>
                                            </div>
                                        ...
                                        <div className="media-body">
                                            <div className="media-title">
                                                <a href="#">
                                                    ...
                                                    <span
                                                        className="text-muted float-right font-size-sm">12:16</span>
                                                </a>
                                            </div>
                                        ...
                                        <div className="media-body">
                                            <div className="media-title">
                                                <a href="#">
                                                    ...
                                                    <span
                                                        className="text-muted float-right font-size-sm">22:48</span>
                                                </a>
                                            </div>
                            ...
                            <div className="dropdown-content-footer justify-content-center p-0">
                                <a href="#" className="bg-light text-grey w-100 py-2" data-popup="tooltip"
                                   title="Load more"><i className="icon-menu7 d-block top-0"></i></a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li className="nav-item dropdown dropdown-user">
                        ...
                        <div className="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="#" className="dropdown-item"><i
                                className="icon-comment-discussion"></i> Messages <span
